	...
	default:
		...
		if matches != nil {
			...
			case "popular":
				...
				handler.apiRefPlaylist(w, r, spiff.TypeMusic, m, vid, p,
					artist.Name,
		...
		if matches != nil {
			...
			case "movies":
				...
				if res == "playlist" {
					movie, _ := vid.LookupMovie(id)
					handler.apiRefPlaylist(w, r, spiff.TypeVideo, m, vid, p,
						"Movie", // TODO
						movie.Title,
			...
			case "series":
				...
				if res == "playlist" {
					...
					handler.apiRefPlaylist(w, r, spiff.TypePodcast, m, vid, p,
						series.Author,
						series.Title,
